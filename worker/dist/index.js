    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield consumer.run({
            ...
            eachMessage: (_a) => __awaiter(this, [_a], void 0, function* ({ topic, partition, message }) {
                ...
                const zapRunDetail = yield primsaclient.zapRun.findFirst({
                    where: {
                        id: zapRunId
                    },
                    include: {
                ...
                const currentAction = zapRunDetail === null || zapRunDetail === void 0 ? void 0 : zapRunDetail.zap.actions.find(x => x.sortingOrder === stage);
                if (!currentAction) {
                ...
                const lastStage = (((_f = zapRunDetail === null || zapRunDetail === void 0 ? void 0 : zapRunDetail.zap.actions) === null || _f === void 0 ? void 0 : _f.length) || 1) - 1;
                if (lastStage !== stage) {
                    yield producer.send({
                        topic: TOPIC_NAME,
                        messages: [{
